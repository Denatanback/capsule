    ...
    <div className="min-h-screen flex" style={{ background: "var(--bg-primary)" }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center relative overflow-hidden"
        ...
        <div className="text-center z-10 px-12">
          <h1 className="text-6xl font-extrabold text-white mb-4 tracking-tight">Capsule</h1>
          <p className="text-xl text-white/80 font-medium">Your space to connect, talk, and play.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-md">
          ...
          <p className="mb-8" style={{ color: "var(--text-muted)", fontSize: "14px" }}>Sign in to continue to Capsule</p>
          ...
          <p className="mt-8 text-center text-sm" style={{ color: "var(--text-muted)" }}>
            No account? <Link to="/register" className="font-semibold hover:underline" style={{ color: "var(--accent)" }}>Create one</Link>
          </p>
        </div>
      </div>
    </div>
