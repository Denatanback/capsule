...
export async function channelRoutes(app: FastifyInstance) {
  ...
  // Create channel
  app.post("/api/servers/:serverId/channels", { preHandler: requireAuth as any }, async (request, reply) => {
  ...
  app.get("/api/servers/:serverId/channels", { preHandler: requireAuth as any }, async (request, reply) => {
    const { serverId } = request.params as { serverId: string };
    const userId = (request as any).userId;
  ...
  // Update channel
  app.patch("/api/servers/:serverId/channels/:channelId", { preHandler: requireAuth as any }, async (request, reply) => {
  ...
  // Delete channel
  app.delete("/api/servers/:serverId/channels/:channelId", { preHandler: requireAuth as any }, async (request, reply) => {
    const { serverId, channelId } = request.params as { serverId: string; channelId: string };
    const userId = (request as any).userId;
